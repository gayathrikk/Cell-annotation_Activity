...
public class Cellannotation_Activity {
	...
	.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@title='Cell Annotation']")));
	if (HdElement != null && HdElement.isDisplayed()) {
	HdElement.click();
	System.out.println("Cell Annotation Icon clicked successfully");
	} else {
	System.out.println("Cell Annotation Icon is not clicked");
	}
	Thread.sleep(7000);
	...
	String[] expectedFileName = { "Cell Annotation" };
